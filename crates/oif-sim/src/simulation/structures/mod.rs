...
mod gravity;
pub(super) use gravity::gravity_moves;
mod plan;
pub(super) use plan::merge_structure_movement_plan;
mod execute;
pub(super) use execute::apply_fragile_shatter_before_execute;
pub(super) use execute::execute_structure_moves_with_pushers;
mod collision;
use collision::can_move_gravity_structure;
use collision::can_move_own_extended_heads;
pub(super) use collision::can_rotate_structure;
pub(super) use collision::can_translate_structure;
use collision::expanded_move_structure;
pub(super) use collision::expanded_move_structure_with_occupancy;
use collision::hard_pusher_head_blocked_below;
use collision::hard_pusher_head_blocks_move;
pub(super) use collision::movement_expansion_mode;
use collision::own_extended_heads;
use collision::rotate_facing;
pub(super) use collision::rotate_pos_y;
pub(super) use collision::rotate_structure;
pub(super) use collision::stamp_collisions;
pub(super) use collision::stamp_collisions_for_rotation;
use collision::structure_id_gravity_grounded;
use collision::structure_supported_by_lifter;
use collision::with_factory_attachment_children;
use collision::with_pusher_heads;
mod occupancy;
pub(super) use occupancy::MovingOccupancy;
pub(super) use occupancy::arbitrate_movement_plan;
