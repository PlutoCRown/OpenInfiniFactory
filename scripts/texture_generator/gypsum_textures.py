...
ROOT = Path('/Volumes/APFS/Project/My/OpenInfiniFactory/assets/material_blocks')
...
def draw_slope_icon(tex: Image.Image, size=128) -> Image.Image:
    ...
    # front/right
    front = [(cx-6, cy+22), (cx+42, cy-6), (cx+42, cy+12), (cx-6, cy+40)]
    draw.polygon(top, fill=light+(255,))
    draw.polygon(left, fill=dark+(255,))
...
src_glb = Path('/Volumes/APFS/Project/My/OpenInfiniFactory/assets/scene_blocks/quartz_slope/model.glb')
