# OpenInfiniFactory
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/PlutoCRown/OpenInfiniFactory)
...
|------|------|
| **平台方块** | 最基础的工厂方块用于连接结构 |
| **传送带 / 反向传送带** | 可以运输皮带上的结构。有时也会让自己移动 |
| **活塞 / 阻拦器** | 通电后会推出其前面的方块！ |
| **抬升器** | 使其上方的结构获得悬浮效果 |
| **旋转器 / 逆向旋转器** | 能将结构进行旋转 |
| **焊接器 / 向下焊接器** | 将材料们焊接为一体！ |
...
2. 新增吸盘、折射镜、面板灯等功能。方块传感器还会检测激光。
3. 方块检测器不会给相邻的用电器供电。方块的可用连接面与模型更匹配。
4. 没有计数器。
5. 更自由的关卡自定义编辑器
