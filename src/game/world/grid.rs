...
pub use oif_sim::world::grid::{
    ...
    GeneratorMode, GeneratorSettings, GoalSettings, LabelerSettings, MaterialFace,
    MaterialFaceMark, MaterialFaceMarkSource, MaterialWeld, REACH, StoredAcceptorStructure,
