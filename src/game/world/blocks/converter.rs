...
const MODEL: &[BlockModelPart] = &[
    ...
    BlockModelPart::new(ModelMesh::Small, ModelMaterial::TeleportIn, [-0.28, 0.54, 0.0]),
    BlockModelPart::new(ModelMesh::Small, ModelMaterial::TeleportOut, [0.28, 0.54, 0.0]),
    BlockModelPart::new(ModelMesh::RodX, ModelMaterial::SystemAccent, [0.0, 0.54, 0.0])
