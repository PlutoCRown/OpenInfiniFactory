...
pub(super) fn assets(_block: &PusherBlock) -> BlockRenderAssets {
    RENDER_ASSETS
}
...
pub(super) fn render_behavior(_block: &PusherBlock, facing: Facing) -> RenderBehavior {
    RenderBehavior {
...
pub(super) fn model(_block: &PusherBlock) -> BlockModel {
